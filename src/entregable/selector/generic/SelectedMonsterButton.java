...
class SelectedMonsterButton extends JButton {
  ...
  SelectedMonsterButton(MonsterSelector selector, Monster monster, Image icon) {
    super();
  ...
  protected void paintComponent(Graphics g) {
    ...
    g2D.drawImage(icon, 0, 0, BUTTON_SIZE, BUTTON_SIZE, null);
    g2D.drawImage(overlay, 0, 0, BUTTON_SIZE, BUTTON_SIZE, null);
  }
