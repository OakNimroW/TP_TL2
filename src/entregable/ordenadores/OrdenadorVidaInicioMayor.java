...
/**
 * Clase que implementa la interfaz Ordenador y la interfaz Comparator para
 * ordenar una lista de monstruos.
 * 
...
public class OrdenadorVidaInicioMayor implements Ordenador, Comparator<Monster> {
     ...
     * @return Un valor negativo si m1 tiene una vida mayor que m2, un valor
     *         positivo si m2 tiene una vida mayor que m1,
     ...
     * @return La lista de monstruos ordenada en base a su vida en orden
     *         descendente.
     */
